...
const unsigned long postingInterval = 50L * 1000L; // Post data every 50 seconds
...
void setup() 
{
  ...
  Serial.print("Waiting to start parallel park test");
  start_or_stop_parallel_park_test();
}
...
void httpRequest(char* jsonBuffer) {
  ...
  if(stop_parallel_park == 0)
  {
    ...
    ThingSpeak.writeField(myChannelNumber, 3, 2, myWriteAPIKey);
    while(1)
    {
      Serial.println(".");
      delay(1000);
